...
from .views import (
    ...
    JobRoutingOverrideView, JobUrlCheckView,
    # Phase 5
...
urlpatterns = [
    ...
    path('identity-repair/', JobIdentityRepairView.as_view(), name='job-identity-repair'),
    ...
    path('<int:pk>/routing-override/', JobRoutingOverrideView.as_view(), name='job-routing-override'),

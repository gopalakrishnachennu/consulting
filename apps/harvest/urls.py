...
from .views import (
    ...
    RawJobClassificationReviewActionView,
    RawJobClassificationQueueActionView,
    RawJobClassificationQueueView,
    RawJobPushToVettingView,
    RawJobDetailView,
    RawJobSecondaryClassificationIngestView,
    RawJobSecondaryClassificationRunView,
    RawJobListView,
    ...
    RunRawJobClassificationBackfillView,
    ...
    RunCleanupNowView,
    RunVetLiveIntegrityCleanupView,
    RunDetectNowView,
...
urlpatterns = [
    ...
    path("raw-jobs/classification-queue/", RawJobClassificationQueueView.as_view(), name="harvest-rawjob-review-queue"),
    path("raw-jobs/classification-queue/actions/", RawJobClassificationQueueActionView.as_view(), name="harvest-rawjob-review-queue-actions"),
    path("raw-jobs/<int:pk>/classification/review/", RawJobClassificationReviewActionView.as_view(), name="harvest-rawjob-classification-review"),
    path("raw-jobs/<int:pk>/classification/ingest/", RawJobSecondaryClassificationIngestView.as_view(), name="harvest-rawjob-secondary-ingest"),
    path("raw-jobs/<int:pk>/classification/run-secondary/", RawJobSecondaryClassificationRunView.as_view(), name="harvest-rawjob-secondary-run"),
    path("raw-jobs/<int:pk>/classification/push/", RawJobPushToVettingView.as_view(), name="harvest-rawjob-push-vetting"),
    ...
    path("run/vet-live-integrity-cleanup/", RunVetLiveIntegrityCleanupView.as_view(), name="harvest-run-vet-live-integrity-cleanup"),
    ...
    path("run/classification-backfill/", RunRawJobClassificationBackfillView.as_view(), name="harvest-run-classification-backfill"),
